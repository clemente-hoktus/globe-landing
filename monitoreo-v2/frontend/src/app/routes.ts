export const APP_ROUTES = {
  ...
  slosDatos: '/admin/slos',
  throttleCargas: '/admin/throttle',
  retencionPrivacidad: '/admin/retencion',
  replicaDatos: '/admin/replica',
  ...
  resumen: '/resumen',
  centros: '/centros',
  centroDetail: '/centros/:centroId',
  remarcadores: '/remarcadores',
  remarcadorDetail: '/remarcadores/:remarcadorId',
  buildings: '/buildings',
  map: '/map',
  buildingDetail: '/buildings/:buildingId',
  unitDetail: '/buildings/:buildingId/units/:unitId',
  meters: '/meters',
  alerts: '/alerts',
