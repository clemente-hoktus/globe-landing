...
export const UNIFIED_NAV: UnifiedNavGroup[] = [
  {
    ...
    entries: [
      ...
      { label: 'Alertas', icon: 'alerts', to: APP_ROUTES.alarmasAgregadas, basePath: '/dashboard/alarmas', extraPaths: ['/operacional/alarmas'], requiredPerms: ['dashboard_executive:read', 'alerts:read'] },
      { label: 'Exportar', icon: 'admin', to: APP_ROUTES.exportarReportes, basePath: '/dashboard/exportar', extraPaths: ['/auditor/evidencia'], requiredPerms: ['reports:read', 'reports:view_own', 'audit:read'] },
  ...
  },
  {
    ...
    entries: [
      ...
      { label: 'Calidad de Datos', icon: 'admin', to: APP_ROUTES.calidadBackfill, basePath: '/operacional/calidad', extraPaths: ['/auditor/calidad-datos'], requiredPerms: ['data_quality:read', 'audit:read'] },
      { label: 'CNR', icon: 'admin', to: APP_ROUTES.cnrPendientes, basePath: '/operacional/cnr', extraPaths: ['/tecnico/cnr'], requiredPerms: ['data_quality:read', 'dashboard_technical:read', 'readings:read'] },
